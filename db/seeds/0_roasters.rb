...
Roaster.create!(
  reference: "allpress_espresso_uk",
...
Roaster.create!(
  reference: "amid_giants_and_idols",
...
Roaster.create!(
  reference: "aroma_tea_and_coffee",
...
Roaster.create!(
  reference: "artisan_roast_edinburgh",
  name: "Artisan Roast",
...
Roaster.create!(
  reference: "bean_shot_coffee_bruton_somerset",
...
Roaster.create!(
  reference: "bean_dreaming",
  name: "beandreaming",
  description: "Chris and Gaynor Love coffee. Freshly roasted. In Shrewsbury.",
  location: "shrewsbury",
  website: "https://twitter.com/beandreaming",
  twitter: "@beandreaming")

Roaster.create!(
  reference: "beans_and_leaves_wolves",
...
Roaster.create!(
  reference: "beanzz_coffee_eastbourne",
  name: "Beanzz Coffee",
...
Roaster.create!(
  reference: "big_nose_coffee_company",
...
Roaster.create!(
  ...
  website: "https://twitter.com/coffeecaledonia",
  twitter: "@coffeecaledonia")

Roaster.create!(
  reference: "capital_coffee",
  name: "Capital Coffee",
...
Roaster.create!(
  reference: "charlie_mills_coffee",
...
Roaster.create!(
  reference: "coffee_factory",
  name: "Coffee Factory",
  description: "Artisan Coffee Roaster based in Devon, serving awesome award winning coffee since 2009. Lovers of great local food & Coffee obviously ;_)",
...
Roaster.create!(
  reference: "coffee_chocolate_tea",
...
Roaster.create!(
  reference: "colour_coffee_roastery",
...
Roaster.create!(
  reference: "cork_coffee_roasters",
...
Roaster.create!(
  reference: "dear_green_coffee_glasgow",
...
Roaster.create!(
  reference: "drury_tea_and_coffee",
...
Roaster.create!(
  reference: "emelius_and_collinsby",
...
Roaster.create!(
  reference: "foundry_coffee_roasters_sheffield",
...
Roaster.create!(
  reference: "grey_seal_coffee_roastery_north_norfolk",
...
Roaster.create!(
  reference: "hope_and_glory_coffee",
...
Roaster.create!(
  reference: "horsham_coffee_roaster",
  name: "Horsham Coffee",
...
Roaster.create!(
  reference: "isle_of_skye_roastery",
...
Roaster.create!(
  reference: "ismail_coffee_and_tea",
...
Roaster.create!(
  reference: "james_gourmet_coffee",
...
Roaster.create!(
  ...
  website: "https://www.macbeans.com/",
...
Roaster.create!(
  reference: "mission_coffee_works",
...
Roaster.create!(
  reference: "mokarabia_coffee",
  name: "Mokarabia Coffee",
  description: "Mokarabia is a stylish brand of Italian coffee with a remarkable history. Every single bag of coffee we produce contains our know_how and passion.",
  location: "London",
  website: "www.mokarabia.co.uk",
  twitter: "@MokarabiaUK")

Roaster.create!(
  reference: "monmouth_coffee",
...
Roaster.create!(
  reference: "nude_coffee_roasters",
...
Roaster.create!(
  reference: "oxenham_and_leigh_coffee",
...
Roaster.create!(
  reference: "ozone_coffee_roasters",
...
Roaster.create!(
  reference: "passion_fruit_coffee",
...
Roaster.create!(
  reference: "pónaire_irish_handcrafted_coffee",
...
Roaster.create!(
  reference: "red_monkey_coffee_uk",
...
Roaster.create!(
  reference: "roasterb_coffee_co_windsor",
  name: "Roaster B",
...
Roaster.create!(
  reference: "roastworks_coffee_co",
...
Roaster.create!(
  reference: "roundsquare_roastery",
...
Roaster.create!(
  reference: "sasha_house_boutique",
...
Roaster.create!(
  reference: "smiths_coffee_company",
...
Roaster.create!(
  reference: "tapa_organic_glasgow",
...
Roaster.create!(
  reference: "taylors_of_harrogate",
...
Roaster.create!(
  reference: "the_coffee_bean_van_and_roaster",
...
Roaster.create!(
  reference: "the_coffee_company_torquay",
...
Roaster.create!(
  reference: "the_coffee_officina_essex",
...
Roaster.create!(
  reference: "isle_of_wight_espresso_company",
...
Roaster.create!(
  reference: "thistledown_cottage_coffee",
...
Roaster.create!(
  reference: "urban_coffee_company",
...
Roaster.create!(
  ...
  website: "http://www.utopiacoffee.co.uk/",
  twitter: "@Gr8Coffee")

Roaster.create!(
  reference: "volcano_coffee_works",
...
Roaster.create!(
  reference: "york_coffee_emporium",
...
Roaster.create!(
  reference: "cherry_picked_coffee",
...
Roaster.create!(
  reference: "neighbourhood_coffee",
...
Roaster.create!(
  reference: "upperlands_coffee_company",
...
Roaster.create!(
  reference: "inverness_coffee_roasting",
...
Roaster.create!(
  reference: "wilkinsons_of_norwich",
...
Roaster.create!(
  reference: "stokes_tea_and_coffee",
...
Roaster.create!(
  reference: "red_bank_coffee_roasters",
...
Roaster.create!(
  reference: "the_blue_bean_coffee_co",
...
Roaster.create!(
  reference: "coffee_spot_roasters",
...
Roaster.create!(
  reference: "full_circle_roasters",
...
Roaster.create!(
  reference: "baobab_coffee_roasters",
...
Roaster.create!(
  reference: "modern_standard_coffee",
...
Roaster.create!(
  reference: "bruce_&_lukes_coffee",
...
Roaster.create!(
  reference: "northern_edge_coffee",
...
Roaster.create!(
  reference: "frazers_coffee_roasters",
...
Roaster.create!(
  reference: "heart&graft_roastery",
...
Roaster.create!(
  reference: "masteroast_coffee_co_ltd",
...
Roaster.create!(
  reference: "jerichocoffeetraders",
...
Roaster.create!(
  reference: "coffee_direct_scotland",
...
Roaster.create!(
  reference: "quarter_horse_coffee",
...
Roaster.create!(
  reference: "godfrey_c_williams_&_son_ltd",
...
Roaster.create!(
  reference: "pharmacie_coffee_roasters",
...
Roaster.create!(
  reference: "iron_&_fire_speciality_coffee_roasters",
...
Roaster.create!(
  reference: "decadent_decaf_coffee_company",
...
Roaster.create!(
  reference: "green_bridge_organics",
...
Roaster.create!(
  reference: "zombie_coffee_co_&_roastery",
...
Roaster.create!(
  reference: "pebble_&_pine_coffee",
...
Roaster.create!(
  reference: "makushi_coffee_roasters",
...
Roaster.create!(
  reference: "merchant_and_miller_cheshire_coffee",
...
Roaster.create!(
  reference: "lost_barn_coffee_roasters_ltd",
...
Roaster.create!(
  reference: "pollards_wholesale_coffee",
...
Roaster.create!(
  reference: "hayling_island_coffee_society",
...
Roaster.create!(
  reference: "bloss_coffee_company",
...
Roaster.create!(
  reference: "white_rose_coffee_roasters",
...
Roaster.create!(
  reference: "bridge_coffee_roasters",
...
Roaster.create!(
  reference: "two_dogs_coffee_roasting_company",
...
Roaster.create!(
  reference: "carringtons_coffee_co.",
...
Roaster.create!(
  reference: "roast_lab_coffee_roasters",
